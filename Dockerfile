###########MAINTEANCE-HISTORY####################
# 15-01-2020	ACHAK	Initial Draft of the DB Dockerfile
# 16-01-2020	ACHAK	Changed the access keys to the server
# 20-01-2020	ACHAK	Changed the root user to POSTGRES
# 10-04-2020    KVARM	Changed the username and password of DB
#
#
#
#
...
RUN    /etc/init.d/postgresql start &&\
    ...
    psql --command "CREATE DATABASE huda_backup;" 
